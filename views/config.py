...
def upload_page():
    ...
    wbs_file = st.file_uploader("Upload WBS Excel file", type=["xlsx"], key="wbs_uploader")
    ...
    timesheet_file = st.file_uploader("Upload Timesheet Excel file", type=["xlsx"], key="timesheet_uploader")
